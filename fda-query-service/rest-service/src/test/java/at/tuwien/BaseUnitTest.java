...
public abstract class BaseUnitTest {
    ...
    public final static ContainerImage CONTAINER_1_IMAGE = IMAGE_2;
    ...
    public final static ContainerImage CONTAINER_3_IMAGE = IMAGE_2;
    ...
    public final static String QUERY_1 = "SELECT " + COLUMN_1_1_INTERNAL_NAME +","+ COLUMN_1_2_INTERNAL_NAME + " FROM "+TABLE_2_NAME;
    public final static String QUERY_1_NORMALIZED = "SELECT " + COLUMN_1_2_INTERNAL_NAME +","+ COLUMN_1_1_INTERNAL_NAME + " FROM "+TABLE_2_NAME;
}
